 ...
 */
const DEFAULT_GEMINI_KEY = 'AQ.Ab8RN6JC_3bIEgkHihKz6UfBtUCrRS7OlesYQOC7B-3b_qHb3g';
...
// Defaults to OpenRouter, not Gemini: as of Sept 2026, Google is migrating
// every API key to a new "AQ." (Authorization Key) format, and their own
// Generative Language REST API is currently rejecting these new keys with
// a 401 (confirmed widely reported on Google's own developer forum, not
// specific to this key or this app). OpenRouter's auth is unaffected.
// Revisit once Google resolves this on their end -- nothing here needs to
// change again if/when that happens, since getApiKey() still works fine,
// this is purely about which provider a fresh device starts on.
