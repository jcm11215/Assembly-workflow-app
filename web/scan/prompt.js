...
export const PROMPT_VERSIONS = {
  classify: 1,
  parts: 3,   // reads one sheet, or its enlarged table
...
Do NOT include gaskets, coupling bolts, UHMW, plates, weldments, sprockets, keys, guards, other fasteners, trough sections, covers, shrouds, or discharge spouts/chutes -- even if clearly listed. This is a fixed whitelist, not a completeness target. Check every page given to you: a set can carry its parts table across more than one sheet.
