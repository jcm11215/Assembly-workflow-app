...
const { resolveLocations } = await import('../../web/scan/scanJoin.js');
...
const { pageOfBlocks } = await import('../../web/scan/pipeline.js');
const { preparePages } = await import('../../web/scan/scanLayers.js');
